...
public class AppTest {
  ...
  public static void testSetup() throws Exception {
    ...
    testStateDefault = Config.get("test_state.default", "Salzburg");
    testTownDefault = Config.get("test_town.default", "Aigen");
    testStateAlternative = Config.get("test_state.alternative", "Steiermark");
    testTownAlternative = Config.get("test_town.alternative", "Graz");
